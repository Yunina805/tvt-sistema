...
#[Layout('layouts.app')]
class ActividadesTarifasAdicionales extends Component
{
    use WithPagination, WithToasts;

    const TIPO = 'TARIFA_ADICIONAL';
    ...
    public function render()
    {
        ...
        return view('livewire.catalogos.servicios.actividades-tarifas-adicionales', [
            'total'       => $total,
            'activos'     => $activos,
            'servicios'   => $servicios,
            'puestos'     => $puestos,
