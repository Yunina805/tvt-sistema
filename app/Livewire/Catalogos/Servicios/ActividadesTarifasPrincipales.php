...
#[Layout('layouts.app')]
class ActividadesTarifasPrincipales extends Component
{
    use WithPagination, WithToasts;

    const TIPO = 'TARIFA_PRINCIPAL';
    ...
    public function render()
    {
        ...
        return view('livewire.catalogos.servicios.actividades-tarifas-principales', [
            'total'       => $total,
            'activos'     => $activos,
            'servicios'   => $servicios,
            'puestos'     => $puestos,
