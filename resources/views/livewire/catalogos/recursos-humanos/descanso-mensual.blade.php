<div>
    ...
    {{-- Panel de Filtros --}}
    @php $hayFiltros = $search || $filtroAnio || $filtroMes || $filtroEstado; @endphp
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm mb-4" x-data="{ openFilters: true }">
        ...
        <div x-show="openFilters" x-cloak class="border-t border-gray-100 px-5 pt-4 pb-5">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    <label class="block text-[9px] font-black uppercase tracking-widest text-gray-500 mb-1.5">Año</label>
                ...
                <div>
                    <label class="block text-[9px] font-black uppercase tracking-widest text-gray-500 mb-1.5">Mes</label>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-5 py-3">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <button @click="$confirm('¿Eliminar este registro de descanso?', () => $wire.eliminar({{ $d->id }}), { icon: 'warning', confirmText: 'Sí, eliminar' })"
