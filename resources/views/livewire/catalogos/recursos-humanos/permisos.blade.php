<div>
    ...
    {{-- Panel de Filtros --}}
    @php $hayFiltros = $search || $filtroTipo || $filtroEstado; @endphp
        ...
        <button type="button" @click="openFilters = !openFilters"
            ...
            <div class="flex items-center gap-3">
                <div class="w-9 h-9 bg-amber-50 rounded-xl flex items-center justify-center shrink-0">
                    <i class="ri-equalizer-2-line text-amber-500 text-base"></i>
                </div>
                <div class="text-left">
                    <p class="text-xs font-black uppercase tracking-widest text-gray-700">Filtros de Búsqueda</p>
                    <p class="text-[9px] font-bold uppercase tracking-widest mt-0.5 {{ $hayFiltros ? 'text-amber-500' : 'text-gray-400' }}">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input wire:model.live.debounce.300ms="search" type="text" placeholder="Nombre del empleado..."
                            class="w-full pl-9 pr-3 py-2.5 text-xs border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-200 focus:border-amber-300 transition-all">
                    </div>
                </div>
                <div>
                    <label class="block text-[9px] font-black uppercase tracking-widest text-gray-500 mb-1.5">Tipo de Permiso</label>
                    <select wire:model.live="filtroTipo"
                        class="w-full py-2.5 px-3 text-xs border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-200 focus:border-amber-300 transition-all">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-5 py-3">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <button @click="$confirm('¿Eliminar este permiso?', () => $wire.eliminar({{ $p->id }}), { icon: 'warning', confirmText: 'Sí, eliminar' })"
