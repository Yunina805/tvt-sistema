<div>
    ...
    {{-- Panel de Filtros --}}
    @php $hayFiltros = $search || $filtroTipo || $filtroPago || $filtroActivo !== ''; @endphp
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="sm:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input wire:model.live.debounce.300ms="search" type="text" placeholder="Nombre, RFC o cuenta..."
                ...
                <div>
                    <label class="block text-[9px] font-black uppercase tracking-widest text-gray-500 mb-1.5">Tipo de Servicio</label>
                ...
                <div>
                    <label class="block text-[9px] font-black uppercase tracking-widest text-gray-500 mb-1.5">Tipo de Pago</label>
