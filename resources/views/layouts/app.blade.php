...
>
    <head>
        ...
        <style>
            ...
            .dark .bg-gray-100    { background-color: #273444; }

            /* Bordes */
            .dark .border-gray-50  { border-color: #1e293b; }
            .dark .border-gray-100 { border-color: #273444; }
            .dark .border-gray-200 { border-color: #334155; }
            .dark .border-slate-200 { border-color: #334155; }
            .dark .border-red-100   { border-color: rgba(127,29,29,.35); }
            ...
            .dark .divide-y > * + *        { border-color: #273444; }
            .dark .divide-gray-50 > * + *  { border-color: #1e293b; }
            .dark .divide-gray-100 > * + * { border-color: #273444; }
            .dark .hover\:bg-gray-50:hover  { background-color: #273444 !important; }
            ...
            .dark aside nav .bg-slate-100   { background-color: #273444 !important; }
            .dark aside nav .hover\:bg-slate-100:hover { background-color: #273444 !important; }
            .dark aside nav .text-slate-700 { color: #94a3b8 !important; }
            .dark aside nav .text-gray-600  { color: #94a3b8 !important; }
            .dark aside nav .text-gray-500  { color: #64748b !important; }

            /* Scrollbar sidebar en dark */
            .dark .sidebar-scroll::-webkit-scrollbar-thumb { background: #475569; }

            /* ── Badges con fondo gris en tablas ── */
            .dark .bg-gray-100.text-gray-700 { background-color: #334155; color: #94a3b8; }
        </style>
    </head>
    ...
    <body class="font-sans antialiased text-gray-900 dark:text-slate-100 bg-gray-50 dark:bg-slate-950">
        ...
        >
            {{-- Logo Corporativo --}}
            <div class="flex items-center h-16 px-4 border-b border-gray-100 dark:border-slate-700 flex-shrink-0 sidebar-logo bg-gray-50/50 dark:bg-slate-800/80">
                <div class="flex items-center gap-2 overflow-hidden">
                    ...
                    <span class="hide-collapsed font-black text-gray-900 dark:text-slate-100 text-sm uppercase tracking-tighter whitespace-nowrap">
            ...
            <nav class="flex-1 overflow-y-auto sidebar-scroll py-4 px-2 space-y-1">
                ...
                @php
                    $adminTvtActive = request()->routeIs([
                        'rrhh.*', 'infraestructura.*', 'energia.ctc', 'plan.*',
                        'financiero.*', 'cat.servicios.*', 'cat.actividades.*',
                    ]);
                @endphp
                @if($_canMod('RRHH') || $_canMod('Infraestructura') || $_canMod('Financiero') || $_canMod('Servicios'))
                <div x-data="{ open: {{ $adminTvtActive ? 'true' : 'false' }} }"
                     @close-nav-top.window="if ($event.detail !== 'adminTvt') open = false">
                    <button @click="open = !open; if (open) $dispatch('close-nav-top', 'adminTvt')"
                    ...
                    <div x-show="open" x-cloak class="mt-1 space-y-0.5 ml-4 border-l-2 border-slate-200 pb-1">
                        ...
                        <div x-data="{ open: {{ $planActive ? 'true' : 'false' }} }"
                            ...
                            <div x-show="open" x-cloak class="mt-1 space-y-0.5 ml-4">
                                ...
                                <a href="#" {{-- TODO: route('plan.actividades') --}}
                                ...
                                <a href="#" {{-- TODO: route('plan.trabajo') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-violet-600 hover:bg-violet-50/50 rounded transition-colors">
                        ...
                        <div x-data="{ open: {{ $cxpActive ? 'true' : 'false' }} }"
                            ...
                            <div x-show="open" x-cloak class="mt-1 space-y-0.5 ml-4">
                                ...
                                <a href="#" {{-- TODO: route('financiero.bancos') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-emerald-600 hover:bg-emerald-50/50 rounded transition-colors">
                                ...
                                <a href="#" {{-- TODO: route('financiero.facturas') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-emerald-600 hover:bg-emerald-50/50 rounded transition-colors">
                        ...
                        <div x-data="{ open: {{ $ingEgActive ? 'true' : 'false' }} }"
                            ...
                            <div x-show="open" x-cloak class="mt-1 space-y-0.5 ml-4">
                                ...
                                <a href="#" {{-- TODO: route('financiero.motivos-traspaso') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-emerald-600 hover:bg-emerald-50/50 rounded transition-colors">
                        ...
                        <div x-data="{ open: {{ $svcActive ? 'true' : 'false' }} }"
                            ...
                            <div x-show="open" x-cloak class="mt-1 space-y-0.5 ml-4">
                                ...
                                <a href="#" {{-- TODO: route('cat.servicios.clientes') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-indigo-600 hover:bg-indigo-50/50 rounded transition-colors">
                ...
                <div x-data="{ open: {{ $clientesGestActive ? 'true' : 'false' }} }"
                     @close-nav-top.window="if ($event.detail !== 'clientes') open = false">
                    <button @click="open = !open; if (open) $dispatch('close-nav-top', 'clientes')"
                            class="nav-item w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-bold transition-all
                ...
                @php
                    $redesGestActive = request()->routeIs([
                        'tv.*', 'red.*', 'energia.ups', 'planta.*', 'energia.fibra',
                    ]);
                @endphp
                <div x-data="{ open: {{ $redesGestActive ? 'true' : 'false' }} }"
                     @close-nav-top.window="if ($event.detail !== 'redesGest') open = false">
                    <button @click="open = !open; if (open) $dispatch('close-nav-top', 'redesGest')"
                            class="nav-item w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-bold transition-all
                    ...
                    <div x-show="open" x-cloak class="mt-1 space-y-0.5 ml-4 border-l-2 border-blue-100 pb-1">
                        ...
                        <div x-data="{ open: {{ $tvActive ? 'true' : 'false' }} }"
                            ...
                            <div x-show="open" x-cloak class="mt-1 space-y-0.5 ml-4">
                                ...
                                <a href="#" {{-- TODO: route('tv.satelites') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-orange-600 hover:bg-orange-50/50 rounded transition-colors">
                                ...
                                <a href="#" {{-- TODO: route('tv.proveedores-senal') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-orange-600 hover:bg-orange-50/50 rounded transition-colors">
                                ...
                                <a href="#" {{-- TODO: route('tv.receptores') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-orange-600 hover:bg-orange-50/50 rounded transition-colors">
                                ...
                                <a href="#" {{-- TODO: route('tv.moduladores-digitales') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-orange-600 hover:bg-orange-50/50 rounded transition-colors">
                                ...
                                <a href="#" {{-- TODO: route('tv.divisores') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-orange-600 hover:bg-orange-50/50 rounded transition-colors">
                        ...
                        <div x-data="{ open: {{ $redActive ? 'true' : 'false' }} }"
                            ...
                            <div x-show="open" x-cloak class="mt-1 space-y-0.5 ml-4">
                                ...
                                <a href="#" {{-- TODO: route('red.olt-interna') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-purple-600 hover:bg-purple-50/50 rounded transition-colors">
                                ...
                                <a href="#" {{-- TODO: route('red.isp-telmex') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-purple-600 hover:bg-purple-50/50 rounded transition-colors">
                                ...
                                <a href="#" {{-- TODO: route('red.switches') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-purple-600 hover:bg-purple-50/50 rounded transition-colors">
                                ...
                                <a href="#" {{-- TODO: route('red.encapsulamiento') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-purple-600 hover:bg-purple-50/50 rounded transition-colors">
                        ...
                        <div x-data="{ open: {{ ($upsActive || $fibraActive || $ctcActive) ? 'true' : 'false' }} }"
                            ...
                            <div x-show="open" x-cloak class="mt-1 space-y-0.5 ml-4">
                                ...
                                <a href="#" {{-- TODO: route('energia.plantas') --}}
                                   class="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-gray-500 hover:text-yellow-600 hover:bg-yellow-50/50 rounded transition-colors">
                ...
                <div x-data="{ open: {{ $regulatorioActive ? 'true' : 'false' }} }"
                     @close-nav-top.window="if ($event.detail !== 'regulatorio') open = false">
                    <button @click="open = !open; if (open) $dispatch('close-nav-top', 'regulatorio')"
                            class="nav-item w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-bold transition-all
                                   {{ $regulatorioActive ? 'bg-rose-50 text-rose-700' : 'text-gray-600 hover:bg-rose-50 hover:text-rose-700' }}">
                        <i class="ri-government-line text-lg {{ $regulatorioActive ? 'text-rose-600' : 'text-rose-400' }}"></i>
                        <span class="hide-collapsed flex-1 text-left uppercase tracking-tighter">Catálogos Regulatorios</span>
                        <i class="hide-collapsed ri-arrow-down-s-line transition-transform duration-200" :class="open && 'rotate-180'"></i>
                    </button>
                    <div x-show="open" x-cloak class="mt-1 space-y-0.5 ml-4 border-l-2 border-rose-100 pb-1">
                        ...
                        <a href="#" {{-- TODO: route('regulatorio.entidades') --}}
                        ...
                        <a href="#" {{-- TODO: route('regulatorio.documentos') --}}
                           class="flex items-center gap-2.5 px-4 py-2 text-xs font-bold text-gray-500 hover:text-rose-600 hover:bg-rose-50/50 rounded-r-lg transition-colors">
                        ...
                        <a href="#" {{-- TODO: route('regulatorio.obligaciones') --}}
                           class="flex items-center gap-2.5 px-4 py-2 text-xs font-bold text-gray-500 hover:text-rose-600 hover:bg-rose-50/50 rounded-r-lg transition-colors">
            ...
            <div class="flex flex-col flex-1 min-w-0 overflow-hidden relative bg-gray-50 dark:bg-slate-950">
                ...
                {{-- TOP BAR --}}
                <header class="flex items-center justify-between h-16 px-4 md:px-6 bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] flex-shrink-0 z-20">
                    <div class="flex items-center gap-3">
                ...
                {{-- FOOTER --}}
                <footer class="flex-shrink-0 px-6 py-4 bg-transparent border-t border-gray-200/60 dark:border-slate-700/60 text-[11px] text-gray-400 dark:text-slate-500 flex items-center justify-between">
                    <span class="font-medium text-gray-500 dark:text-slate-500">TVT Sistema &copy; {{ date('Y') }} — Tu Visión Telecable</span>
